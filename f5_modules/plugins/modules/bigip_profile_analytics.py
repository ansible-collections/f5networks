...
options:
  collect_geo:
    description:
    - Enables or disables the collection of the names of the countries from where
      the traffic was sent.
    type: bool
  collect_ip:
    description:
  ...
  collect_max_tps_and_throughput:
    description:
    - Enables or disables the collection of maximum TPS and throughput for all collected
      entities.
    type: bool
  ...
  external_logging_publisher:
    description:
    - Specifies the external logging publisher used to send statistical data to one
  ...
  notification_email_addresses:
    description:
    - Specifies which email addresses receive alerts by email when C(notification_by_email)
      is enabled.
    type: list
  parent:
    description:
