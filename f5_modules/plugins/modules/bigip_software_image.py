...
- Tim Rupp (@caphrim007)
description:
- Manages software images on a BIG-IP. These images may include both base images and
  hotfix images.
...
options:
  force:
    ...
    - Generally should be C(yes) only in cases where you have reason to believe that
