...
options:
  arp_log_level:
    ...
    - warning
    description:
    - Specifies the lowest level of ARP messages from the tmm daemon to include in
      the system log.
    type: str
  ...
  http_log_level:
    ...
    - warning
    description:
    - Specifies the lowest level of HTTP messages from the tmm daemon to include in
      the system log.
    type: str
  ip_log_level:
    choices:
    ...
    - warning
    description:
    - Specifies the lowest level of IP address messages from the tmm daemon to include
      in the system log.
    type: str
  irule_log_level:
    choices:
    ...
    - warning
    description:
    - Specifies the lowest level of iRule messages from the tmm daemon to include
      in the system log.
    type: str
  layer4_log_level:
    choices:
    ...
    - notice
    description:
    - Specifies the lowest level of Layer 4 messages from the tmm daemon to include
      in the system log.
    type: str
  net_log_level:
    choices:
    ...
    - warning
    description:
    - Specifies the lowest level of network messages from the tmm daemon to include
      in the system log.
    type: str
  os_log_level:
    choices:
  ...
  pva_log_level:
    ...
    - notice
    description:
    - Specifies the lowest level of PVA messages from the tmm daemon to include in
      the system log.
    type: str
  ssl_log_level:
    choices:
    ...
    - warning
    description:
    - Specifies the lowest level of SSL messages from the tmm daemon to include in
      the system log.
    type: str
  state:
    choices:
    ...
    default: present
    description:
    - The state of the log level on the system. When C(present), guarantees that an
      existing log level is set to C(value).
    type: str
