...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigiq_application_fastl4_tcp import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigiq_application_fastl4_tcp import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigiq_application_fastl4_tcp import ArgumentSpec
