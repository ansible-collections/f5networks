...
from ansible_collections.f5networks.network.plugins.module_utils.network.common.utils import validate_ip_address

try:
    # Ansible 2.6 and later
    from ansible_collections.f5networks.network.plugins.module_utils.network.common.utils import validate_ip_v6_address
except ImportError:
    import socket
