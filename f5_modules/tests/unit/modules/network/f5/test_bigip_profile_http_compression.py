...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_profile_http_compression import ApiParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_profile_http_compression import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_profile_http_compression import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_profile_http_compression import ArgumentSpec
