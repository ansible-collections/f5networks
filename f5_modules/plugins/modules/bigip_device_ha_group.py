...
options:
  ...
  pools:
    ...
    suboptions:
      ...
      minimum_threshold:
        description:
        - Below this value the selected pool attribute contributes nothing to the
          ha score.
        - This value must be greater than the number of pool members present in the
          pool.
        - In TMOS versions 12.x this attribute is named C(threshold) however it has
          been deprecated in versions 13.x and above.
        - Specifying this attribute in the module running against v12.x will keep
          the same behavior as if C(threshold) option was set.
        type: int
      partition:
        default: Common
        description:
        - Device partition where the specified pool exists.
        - This parameter is ignored if the C(pool_name) is specified in full path
          format.
        type: str
      pool_name:
        description:
        ...
        - When pool is referenced in full path format, the C(partition) parameter
          is ignored.
        required: true
        type: str
      weight:
  ...
  trunks:
    ...
    suboptions:
      ...
      minimum_threshold:
        description:
        - Below this value the selected trunk attribute contributes nothing to the
          ha score.
