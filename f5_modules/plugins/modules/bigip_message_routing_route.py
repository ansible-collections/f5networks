...
options:
  ...
  dst_address:
    ...
    - Setting the attribute to an empty string will create a wildcard matching all
      message destination-addresses, which is the default when creating a new route.
    type: str
  name:
    description:
  ...
  peer_selection_mode:
    ...
    - sequential
    description:
    - Specifies the method to use when selecting a peer from the provided list of
      C(peers).
    type: str
  peers:
    description:
  ...
  src_address:
    ...
    - Setting the attribute to an empty string will create a wildcard matching all
      message source-addresses, which is the default when creating a new route.
    type: str
  state:
    choices:
    - present
