...
description:
- Manages global GTM settings. These settings include general, load balancing, and
...
options:
  synchronization:
    ...
    - When you enable synchronization, the system periodically queries other systems
      in the synchronization group to obtain and distribute configuration and metrics
      collection updates.
    - The synchronization group may contain systems configured as Global Traffic Manager
      and Link Controller systems.
    type: bool
  ...
  synchronize_zone_files:
    description:
    - Specifies that the system synchronizes Domain Name System (DNS) zone files among
      the synchronization group members.
    type: bool
