...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_device_info import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_device_info import VirtualAddressesFactManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_device_info import ArgumentSpec
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_device_info import ModuleManager
