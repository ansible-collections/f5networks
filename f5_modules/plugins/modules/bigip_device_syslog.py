...
options:
  auth_priv_from:
    ...
    - warning
    description:
    - Specifies the lowest level of messages about user authentication to include
      in the system log.
    type: str
  auth_priv_to:
    choices:
    ...
    - warning
    description:
    - Specifies the highest level of messages about user authentication to include
      in the system log.
    type: str
  console_log:
    description:
  ...
  cron_from:
    ...
    - warning
    description:
    - Specifies the lowest level of messages about time-based scheduling to include
      in the system log.
    type: str
  cron_to:
    choices:
    ...
    - warning
    description:
    - Specifies the highest level of messages about time-based scheduling to include
      in the system log.
    type: str
  daemon_from:
    choices:
    ...
    - warning
    description:
    - Specifies the lowest level of messages about daemon performance to include in
      the system log.
    type: str
  daemon_to:
    choices:
    ...
    - warning
    description:
    - Specifies the highest level of messages about daemon performance to include
      in the system log.
    type: str
  include:
    description:
  ...
  user_log_from:
    ...
    - warning
    description:
    - Specifies the lowest level of user account messages to include in the system
      log.
    type: str
  user_log_to:
    choices:
    ...
    - warning
    description:
    - Specifies the highest level of user account messages to include in the system
      log.
    type: str
