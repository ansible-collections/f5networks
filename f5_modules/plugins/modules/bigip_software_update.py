...
options:
  auto_check:
    description:
    - Specifies whether to automatically check for updates on the F5 Networks downloads
      server.
    type: bool
  auto_phone_home:
    description:
    - Specifies whether to automatically send phone home data to the F5 Networks PhoneHome
      server.
    type: bool
  frequency:
    choices:
