...
options:
  log_format_delimiter:
    ...
    - When creating a new profile, if this parameter is not specified, the default
      value of C(,) (the comma character) will be used.
    - This option is valid when the C(log_storage_format) is set to C(field-list).
      It will be ignored otherwise.
    - Depending on the delimiter used, it may be necessary to wrap the delimiter in
      quotes to prevent YAML errors from occurring.
  ...
  log_matches_accept_rule:
    description:
    - Modify log settings for ACL rules configured with an "accept" or "accept decisively"
      action.
    suboptions:
      enabled:
        description:
        - This option is used to enable or disable the logging of packets that match
          ACL rules configured with an "accept" or "accept decisively" action.
        type: bool
      rate_limit:
        description:
        - This option is used to set rate limits for the logging of packets that match
          ACL rules configured with an "accept" or "accept decisively" action.
        - This option is effective only if logging of this message type is enabled.
        type: int
    type: dict
  log_matches_drop_rule:
    ...
    suboptions:
      enabled:
        description:
        - This option is used to enable or disable the logging of packets that match
          ACL rules configured with a drop action.
        type: bool
      rate_limit:
        description:
        - This option is used to set rate limits for the logging of packets that match
  ...
  log_matches_reject_rule:
    ...
    suboptions:
      enabled:
        description:
        - This option is used to enable or disable the logging of packets that match
          ACL rules configured with a reject action.
        type: bool
      rate_limit:
        description:
        - This option is used to set rate limits for the logging of packets that match
  ...
  log_publisher:
    ...
    - To specify the log_publisher on a different partition from the AFM log profile,
      ...
      the partition for log publisher is inferred from C(partition) module parameter.
    type: str
  log_storage_format:
    choices:
    - field-list
    ...
    - When creating a new log profile, if this parameter is not specified, the default
      is C(none).
    - When C(field-list), specifies that the log displays only the items you specify
      in the C(log_message_fields) list with C(log_format_delimiter) as the delimiter
      between the items.
  ...
  log_tcp_events:
    ...
    suboptions:
      enabled:
        description:
        - This option is used to enable or disable the logging of TCP events on the
          client side.
      ...
      rate_limit:
        description:
        - This option is used to set rate limits for the logging of TCP events on
          the client side.
        - This option is effective only if logging of this message type is enabled.
        type: int
    type: dict
  log_translation_fields:
    ...
    - This option is used to enable or disable the logging of translated (i.e server
      side) fields in ACL match and TCP events.
  ...
  state:
    ...
    - Only built-in profile that allows updating network log settings is global-network,
