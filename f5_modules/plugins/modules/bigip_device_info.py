...
- This module was called C(bigip_device_facts) before Ansible 2.9. The usage did not
  change.
...
options:
  gather_subset:
    ...
    - '!vlans'
    description:
    - When supplied, this argument will restrict the information returned to a given
      subset.
...
from ansible_collections.f5networks.network.plugins.module_utils.network.common.utils import to_netmask
