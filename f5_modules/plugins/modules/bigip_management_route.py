...
options:
  ...
  gateway:
    description:
    - Specifies that the system forwards packets to the destination through the gateway
  ...
  network:
    ...
    - This parameter cannot be changed after it is set. Therefore, if you do need
      to change it, it is required that you delete and create a new route.
    type: str
  partition:
    default: Common
    description:
