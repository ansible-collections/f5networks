...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigiq_application_http import ModuleParameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigiq_application_http import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigiq_application_http import ArgumentSpec
