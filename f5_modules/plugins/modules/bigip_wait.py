...
- This module can take into account situations where the device is in the middle of
  rebooting due to a configuration change.
...
options:
  ...
  sleep:
    default: 1
    description:
    - Number of seconds to sleep between checks, before 2.3 this was hardcoded to
      1 second.
    type: int
  timeout:
    default: 7200
    ...
    - The default timeout is deliberately set to 2 hours because no individual REST
      API.
    type: int
