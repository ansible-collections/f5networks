...
try:
    ...
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_device_trust import Parameters
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_device_trust import ModuleManager
    from ansible_collections.f5networks.f5_modules.plugins.modules.network.f5.bigip_device_trust import ArgumentSpec
